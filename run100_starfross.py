...
W = {
 ...
 "rockets_honchkrow":1.6,"team_rockets_porygon":0.8,"meganium_ogerpon":0.6,"ogerpon_meganium_arboliva":0.4,"ogerpon_meganium_arboliva_v2":0.4,
 "ogerpon_meganium_hydrapple":0.3,"froslass_arboliva":0.3,
...
USER="starmie_froslass_munkidori"
...
STF=os.path.join(HERE,"data","event100_starfross_state.json")
...
open(os.path.join(HERE,"data","event100_starfross_result.txt"),"w").write("\n".join(L))
pass
print("\n".join(L))
